...
public class ErrorCodesTest {
    ...
    public void testInternalError() {
        ...
        assertEquals("error.internal", bundleKey, "INTERNAL_ERROR should map to the correct bundle key");
    }

    @Test
    public void testValidationError() {
        String bundleKey = ErrorCodes.bundleKey(ErrorCodes.VALIDATION_ERROR);
        assertEquals("error.validation", bundleKey, "VALIDATION_ERROR should map to the correct bundle key");
    }
    ...
    public void testNonExistentErrorCode() {
        ...
        assertEquals(nonExistentCode, bundleKey, "Non-existent error codes should return the code itself");
    }
}

...
class ReadPartnerEntityHandlerTest {
  ...
  void throwsWhenNotFoundById() {
    ...
    assertThrows(PartnerEntityNotFoundException.class, () -> handler.handle(new ReadByIdQuery(id)));

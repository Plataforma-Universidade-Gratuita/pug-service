...
class FormerStudentsReadServiceImplTest {
  ...
  @Test
  @DisplayName("Should return formerStudent view by account ID")
  void getViewByAccountIdSuccess() {
    UUID id = UuidCreator.getTimeOrderedEpoch();
    FormerStudentView view = buildView(id);
  ...
  @Test
  @DisplayName("Should return formerStudent view by registration")
  void getViewByAcademicRegistrationSuccess() {
    FormerStudentView view = buildView(UuidCreator.getTimeOrderedEpoch());
  ...
  @Test
  @DisplayName("Should return formerStudent view by CPF")
  ...
  @Test
  @DisplayName("Should return formerStudent view by email")
  ...
  private FormerStudentView buildView(UUID accountId) {

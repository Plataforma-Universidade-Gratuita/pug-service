...
class FormerStudentsResourceTest extends BaseResourceTest {
  ...
  @TestSecurity(
      user = "admin",
      roles = {"ADMIN"})
  @DisplayName("GET /v1/academic/former-students/{id} - Not Found")
  ...
  @TestSecurity(
      user = "user",
      roles = {"STUDENT"})
  @DisplayName("GET /v1/academic/former-students?courseId= - Filter by Course")
  ...
  void createBulkSuccess() throws Exception {
    ...
    FormerStudentCreateRequest req2 = buildCreateRequest(course[0].getId());
  ...
  void unauthorizedAccess() {
    assertUnauthenticated("/v1/academic/former-students");
  }
  ...
  @TestSecurity(
      user = "formerStudent",
      roles = {"STUDENT"})
  @DisplayName("POST /v1/academic/former-students - Forbidden for STUDENT")
  ...
  @TestSecurity(
      user = "formerStudent",
      roles = {"STUDENT"})
  @DisplayName("DELETE /v1/academic/former-students/{id} - Forbidden for STUDENT")
  ...
  @TestSecurity(
      user = "admin",
      roles = {"ADMIN"})
  @DisplayName("GET /v1/academic/former-students?cpf= - Success")
  ...
  @TestSecurity(
      user = "admin",
      roles = {"ADMIN"})
  @DisplayName("GET /v1/academic/former-students?email= - Success")

...
class SharedDataPresenterTest {
    ...
    void shouldFormatAuditInfoPtBr() {
        ...
        AuditInfoResponse res = SharedDataPresenter.createAuditInfoResponse(now, now, Locale.forLanguageTag("pt-BR"));
    ...
    void shouldTranslateCampus() {
        CampusResponse res = SharedDataPresenter.createCampusResponse(Campi.JARAGUA_DO_SUL, Locale.forLanguageTag("pt-BR"), i18n);

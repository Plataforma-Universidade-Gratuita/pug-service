...
class DomainErrorAndAuditInfoTest {
  ...
  class DomainErrorTests {
    ...
    void shouldAccumulateErrors() {
      ...
      assertThat(entity.getFieldErrors())
          .contains(
              SharedFieldErrorCodes.INVALID_ID_BLANK, SharedFieldErrorCodes.INVALID_NAME_BLANK);
  ...
  class AuditInfoTests {
    ...
    void shouldDetectTemporalError() {
      ...
      assertThat(audit.getFieldErrors())
          .contains(SharedFieldErrorCodes.INVALID_UPDATED_AT_BEFORE_CREATED_AT);
    }

...
SELECT
    ...
    -- Below is the BCrypt hash for the plain password 'Admin123*' (without pepper).
    -- At startup, AdminPasswordSeeder re-hashes it with the configured pepper.
    '$2a$10$cS2VZYyP4Lml6hhYQQhpuetjBJqAmJ3eTKgjGsFtY/.y6qeYXJyUK', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true
FROM new_user
    RETURNING id
    )

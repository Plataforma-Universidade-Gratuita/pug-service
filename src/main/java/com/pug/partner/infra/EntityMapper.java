 ...
 * <p>
 * This mapper acts as an anti-corruption layer, ensuring that the pure Domain model ({@link Entity})
 * does not leak into or depend upon the JPA Persistence model ({@link EntityEntity}).
 */
public final class EntityMapper {
   ...
   * Domain Value Objects (e.g., using {@link Cnpj#factory(String)} and {@link AuditInfo}).
   *
  ...
  /**
   * Translates a pure Domain {@link Entity} aggregate into a newly instantiated JPA {@link EntityEntity}.
   * <p>
   ...
   * @return a newly constructed JPA {@link EntityEntity}, or {@code null} if the input domain is null
   */
  ...
  /**
   * Updates an existing, attached JPA {@link EntityEntity} with the current state of a Domain {@link Entity}.
   * <p>

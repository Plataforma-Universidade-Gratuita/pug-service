 ...
 * <p>
 * This class is the database-mapped counterpart to the {@link com.pug.partner.domain.Staff}
 ...
 * authentication account to grant staff-level access tied to a specific Partner Entity.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class StaffEntity {
   ...
   * foreign key to the identity accounts table. It is strictly immutable once persisted.
   */
  @Id
   ...
   * <p>
   * Acts as a foreign key representing the partner organization this staff member works for.
   */

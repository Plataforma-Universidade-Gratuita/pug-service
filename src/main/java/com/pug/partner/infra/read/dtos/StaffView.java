 ...
 * client. It flattens the complex domain relationships by nesting the underlying authentication
 * identity ({@link AccountView}) alongside the details of the partner organization they represent
 * ({@link EntityView}).
 *

 ...
 * for localized error messages mapped to specific domain properties (e.g., "cnpj", "address").
...
public enum PartnerFieldErrorCodes implements GenericFieldErrorCodes {
  ...
  /**
   * Indicates that a CNPJ string does not match the required format
   * or failed the internal mathematical checksum validation.
   */

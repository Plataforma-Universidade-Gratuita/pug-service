 ...
 * organizational assignment. It applies Jakarta Bean Validation to ensure all required
 * components are present before attempting a complex, multi-domain transaction.
 *
 ...
 * @param entityId    the unique identifier (UUID) of the partner entity they will manage (must not be null)
 */

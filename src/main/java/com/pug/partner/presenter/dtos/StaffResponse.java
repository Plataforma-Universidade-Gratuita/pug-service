 ...
 *
 * <p>This record consolidates the deeply nested backend structure across the Identity, Partner, and
 * Geo domains into a single, comprehensive response representing a user's organizational
 * privileges.
 *
 * @param account the consolidated, client-facing projection of the authentication account and user
 *     profile
 * @param entity the consolidated, client-facing projection of the partner organization and its
 *     location
 */

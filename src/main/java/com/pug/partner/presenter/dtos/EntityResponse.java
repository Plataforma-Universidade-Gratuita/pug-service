 ...
 * <p>
 * This record consolidates the backend entity data along with its resolved geographical location
 ...
 * @param cnpjFormatted the CNPJ string formatted with standard punctuation (e.g., "00.000.000/0000-00")

...
/**
 * Stateless utility class responsible for mapping internal partner entity projections
 * to external API responses.
 * <p>
 * This presenter acts as a translation layer, converting raw CQRS query views ({@link EntityView})
 * into client-ready representations ({@link EntityResponse}). It is responsible for injecting
 * presentation-specific formatting, such as standardizing the Brazilian CNPJ string.
 */
public final class EntityPresenter {
   ...
   * <p>
   * This mapping cascades down to format the nested {@link CityResponse} and resolves
   * localized formatting for audit timestamps and corporate identification numbers.
   *
   ...
   * @return a fully populated {@link EntityResponse} ready for JSON serialization,
   ...
   * <p>
   * Transforms a raw 14-digit numeric string (e.g., "12345678000199") into the
   * standard punctuated format (e.g., "12.345.678/0001-99"). If the input is null
   * or not exactly 14 characters, the raw value is returned safely to prevent exceptions.
   *

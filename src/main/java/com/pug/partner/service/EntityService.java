...
public interface EntityService {
   ...
   * @throws com.pug.shared.exceptions.DuplicateResourceException if an entity with the given CNPJ
   *     already exists
   * @throws com.pug.shared.exceptions.AppValidationException if input validation fails (e.g., blank
   *     name, malformed CNPJ)
   * @throws com.pug.shared.exceptions.ResourceNotFoundException if the referenced City ID does not
   *     exist
   */
   ...
   *
   * <p>This method applies partial updates. If a new City ID is provided, it validates the city's

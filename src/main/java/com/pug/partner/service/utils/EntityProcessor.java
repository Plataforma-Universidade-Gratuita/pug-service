 ...
 * pure {@link Entity} Domain Aggregates and Value Objects.
 * <p>
...
public class EntityProcessor {
   ...
   * (e.g., {@link Cnpj}) before passing them to the entity's factory method.
   * <p>
   * <b>Note:</b> The returned {@link Entity} object may contain accumulated domain validation
   * failures. The caller is responsible for checking {@link Entity#hasFieldErrors()} and
   ...
   * @return a fully instantiated {@link Entity} domain aggregate, potentially containing validation errors
   */
   ...
   * returns a <i>new</i> instance of the {@link Entity} reflecting the applied changes.
   *
   ...
   * @return a new {@link Entity} domain aggregate reflecting the requested updates, potentially containing validation errors
   */

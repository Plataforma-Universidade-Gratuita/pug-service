...
public final class ExceptionHelper {
     ...
     * that a requested Partner Entity could not be located.
     *
     ...
     * that a Partner Entity with the specified CNPJ already exists in the system.
     *
    ...
    /**
     * Instantiates a standardized {@link ResourceNotFoundException} indicating
     * that a requested Staff assignment could not be located.
     *
     * @return a fully configured {@link ResourceNotFoundException} instance
     */
    ...
    /**
     * Instantiates a standardized {@link DuplicateResourceException} indicating
     * that a Staff member assignment already exists for the given account and entity.
     *
     * @return a fully configured {@link DuplicateResourceException} instance
     */
     ...
     * that an account is already assigned as Staff to a different partner entity.
     *

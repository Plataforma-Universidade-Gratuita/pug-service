...
public interface IStaffService {
   ...
   *     account ID already exists or if there are duplicate account IDs in the input commands.
   * @throws com.pug.shared.exceptions.ResourceNotFoundException if any specified entity does not
   *     exist (or data corrupted in DB).
   * @throws com.pug.shared.exceptions.AppValidationException if input validation fails for any
   *     account or staff in the bulk.
   */
   ...
   * @throws com.pug.shared.exceptions.ResourceNotFoundException if the specified staff member does
   *     not exist (or data corrupted in DB).
   * @throws com.pug.shared.exceptions.AppValidationException if input validation fails for account
   *     or staff data.
   */
   ...
   * @throws com.pug.shared.exceptions.AppValidationException if any Staff entity found is corrupted
   *     in the database.
   */
  List<Staff> listAll();

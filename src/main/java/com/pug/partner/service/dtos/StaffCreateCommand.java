 ...
 * a new {@link com.pug.partner.domain.Staff} aggregate, cascading down to provision the necessary
 * authentication account (and potentially the user identity) in a single transaction.
 *

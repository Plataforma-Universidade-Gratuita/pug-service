 ...
 * <p>
 * This record encapsulates the requested state changes for a partner organization. The fields
 * are treated as optional for partial updates; omitting a value will retain the current state
 * in the database.
 *

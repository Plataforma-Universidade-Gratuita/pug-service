...
public interface IEntityService {
     ...
     * @throws com.pug.shared.exceptions.AppValidationException     if input validation fails (e.g., blank name, invalid CNPJ).
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if the city with the given IBGE code does not exist.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if the Entity is not found (or data corrupted) or city is not found.
     * @throws com.pug.shared.exceptions.DuplicateResourceException if an entity with the same CNPJ already exists.
     ...
     * @throws com.pug.shared.exceptions.ReferencedEntityException if any entity is still referenced (e.g., by staff members).
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if the Entity is not found (or data is corrupted in DB).
     */
     ...
     * @throws com.pug.shared.exceptions.AppValidationException if any Entity entity found is corrupted in the database.
     */
    List<Entity> listAll();

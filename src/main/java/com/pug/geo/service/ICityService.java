...
public interface ICityService {
   ...
   * @throws com.pug.shared.exceptions.DuplicateResourceException if a city with the same IBGE code
   *     already exists.
   * @throws com.pug.shared.exceptions.AppValidationException if input validation fails (e.g., blank
   *     name, invalid IBGE code).
   */
   ...
   * @throws com.pug.shared.exceptions.DuplicateResourceException if any city with the same IBGE
   *     code already exists.
   * @throws com.pug.shared.exceptions.AppValidationException if input validation fails for any city
   *     in the bulk.
   */
   ...
   * @throws com.pug.shared.exceptions.ResourceNotFoundException if the city does not exist (or data
   *     is corrupted in DB).
   * @throws com.pug.shared.exceptions.DuplicateResourceException if a city with the same IBGE code
   *     already exists.
   ...
   * @throws com.pug.shared.exceptions.ReferencedEntityException if any city is still referenced by
   *     another entity.
   */
   ...
   * @throws com.pug.shared.exceptions.AppValidationException if the city is found but its data is

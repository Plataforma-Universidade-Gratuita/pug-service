...
public interface ICityReadService {
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no city is found with the given id
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no city is found with the given IBGE code
     */

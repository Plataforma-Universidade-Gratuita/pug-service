...
public final class ExceptionHelper {
  ...
  /**
   * Instantiates a standardized {@link DuplicateResourceException} indicating that a City with the
   * specified IBGE code already exists in the system.
   *
  ...
  /**
   * Instantiates a standardized {@link BusinessRuleException} indicating that an operation cannot
   * be performed on a default City (e.g., Jaraguá do Sul or Joinville).
   *
  ...
  /**
   * Instantiates a standardized {@link BusinessRuleException} indicating that a City cannot be
   * deleted because it is still referenced by other entities (e.g., Partners).
   *
   * @return a fully configured {@link BusinessRuleException} instance
   */

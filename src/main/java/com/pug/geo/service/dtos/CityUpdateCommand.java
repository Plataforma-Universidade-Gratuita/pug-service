...
/**
 * Data Transfer Object (DTO) acting as an application command to update an existing geographic
 * City.
 *
 * <p>This record encapsulates the requested state changes for a city. The fields are typically

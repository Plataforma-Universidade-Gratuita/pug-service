...
public record IbgeCode(String code) {
   ...
   * @throws AppValidationException if the code is invalid, potentially containing multiple problems.
   */
  public IbgeCode {
    ...
    if (StringUtils.isEmpty(code)) {
      ...
      if (code.length() != 7 || !code.chars().allMatch(Character::isDigit)) {
        problems.add(new AppValidationException.Problem(GeoErrorCodes.INVALID_IBGE_CODE_FORMAT, "ibgeCode"));
      }
    }

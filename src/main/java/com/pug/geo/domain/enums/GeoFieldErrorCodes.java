 ...
 * for localized error messages mapped to specific domain properties (e.g., "ibgeCode").
...
public enum GeoFieldErrorCodes implements GenericFieldErrorCodes {
  ...
  /**
   * Indicates that an IBGE code string does not match the required format
   * (e.g., must be exactly 7 numeric digits).
   */

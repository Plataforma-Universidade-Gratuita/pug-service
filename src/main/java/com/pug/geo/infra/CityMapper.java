 ...
 * <p>
 * This mapper acts as an anti-corruption layer, ensuring that the pure Domain model ({@link City})
 * does not leak into or depend upon the JPA Persistence model ({@link CityEntity}) or the
...
public final class CityMapper {
   ...
   * Domain Value Objects (e.g., using {@link IbgeCode#factory(String)}).
   *
  ...
  /**
   * Translates a pure Domain {@link City} aggregate into a newly instantiated JPA {@link CityEntity}.
   * <p>
  ...
  /**
   * Updates an existing, attached JPA {@link CityEntity} with the current state of a Domain {@link City}.
   * <p>
   ...
   * upon transaction commit. The primary key (ID) is intentionally excluded from the copy.
   *

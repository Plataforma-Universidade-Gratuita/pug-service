 ...
 *
 * <p>This enum serves a dual purpose within the platform:
 *
 * <ol>
 *   <li><strong>Business Domain:</strong> Identifies the available academic campuses (Jaraguá do
 *       Sul and Joinville) and provides their internationalization (i18n) keys for localized UI
 *       representation.
 ...
 *       or deletions both at the application level and via database triggers to ensure system
 *       stability.
 * </ol>
 */
@Getter
...
public enum Campi implements GenericCodes {
   ...
   *
   * <p>These codes represent default system cities. This list is utilized by the application's
   * business rules to prevent the modification or deletion of these specific cities, mirroring the
   * database-level protections (e.g., the {@code trg_protect_default_cities} trigger).
   *

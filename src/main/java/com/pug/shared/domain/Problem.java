...
public record Problem(GenericErrorCodes code, String customFieldName) implements Serializable {
    ...
    /**
     * Returns the final field name to be used for this problem, which is either the custom field name if provided, or the default field name from the error code.
     *
    ...
    /**
     * Returns the message key for internationalization, which is obtained from the error code's bundle key.
     *
    ...
    /**
     * Returns a string representation of the problem, including the error code and optional custom field name.
     *

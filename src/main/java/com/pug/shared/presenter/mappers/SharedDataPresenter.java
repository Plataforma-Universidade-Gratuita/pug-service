...
/**
 * Utility class responsible for transforming shared domain data into standardized API Response DTOs.
 * <p>
 * This presenter handles common mapping scenarios used across multiple domains, such as:
 * <ul>
 *   <li>Formatting Audit timestamps (created/updated at) based on the account's locale.</li>
 *   <li>Converting Campus enums into localized response objects.</li>
 * </ul>
 * <p>
...
public final class SharedDataPresenter {
     ...
     * <p>
     * <b>Note:</b> {@code updatedAt} is optional (nullable), but {@code createdAt} and {@code locale} are mandatory.
     *
     ...
     * @return an {@link AuditInfoResponse} containing raw timestamps and their string representations.
     */
    public static AuditInfoResponse createAuditInfoResponse(OffsetDateTime createdAt, OffsetDateTime updatedAt, Locale locale) {

...
public final class PresenterUtils {
   ...
   * @return a localized string representing the remaining days (e.g., "Hoje", "Amanhã", "X dias restantes", "Atrasado").
   */
  public static String formatRemainingDays(LocalDate dueDate, Locale locale, I18n i18n) {
    ...
    if (remainingDays < 0) {
      formattedString = i18n.translation("academic.student.days.overdue", locale, Math.abs(remainingDays));

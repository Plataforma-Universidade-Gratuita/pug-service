...
public final class AccountPresenter {
   ...
   * @throws AppValidationException if internal data (e.g., user's CPF) is invalid during conversion
   *     to UserResponse. This would indicate corrupted data in the read model.
   * @throws ResourceNotFoundException if user data within AccountView is null, preventing
  ...
  public static AccountResponse toResponse(AccountView v, Locale locale, I18n i18n) {
    ...
    if (v.user() == null) {
      throw new ResourceNotFoundException(
          ...
          Map.of("accountId", v.id().toString(), "detail", "Associated user data is missing."));
    }

 ...
 * is structurally sound before it reaches the application service layer. It acts as an
 * aggregate payload that will eventually be split to create the User, Account, and Admin records.
 *

 ...
 * for localized error messages mapped to specific domain properties (e.g., "cpf", "email").
...
public enum IdentityFieldErrorCodes implements GenericFieldErrorCodes {
  ...
  /**
   * Indicates that a CPF string does not match the required format
   * or failed the internal checksum validation.
   */

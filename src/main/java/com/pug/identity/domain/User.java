...
public class User {
    ...
    public static User createNew(
            Cpf cpf, String name, TimeProvider time) {
     ...
     * @return new Person instance with changed name
     */
     ...
     * @return new Person instance with changed CPF
     */
    ...
    /**
     * Validates the Person instance to ensure all required fields are properly set.
     *
     * <p>Checks that cpf, and name are not null, name is not blank and within length limits
    ...
    private void validateAt(Clock clock) {
        ...
        if (name.length() > 150) {
            throw new AppValidationException(IdentityErrorCodes.INVALID_NAME_TOOLONG);
        }
    ...
    /**
     * Validates the Person instance using the system UTC clock.
     *
    ...
    public static class PersonBuilder {
        /**
         * Builds the Person instance and validates it.
         *
         * @return the constructed and validated Person instance
         */
        public User build() {
            User p =
                    new User(id, cpf, StringUtils.trim(name), createdAt);
            p.validate();
            return p;
        }
    }

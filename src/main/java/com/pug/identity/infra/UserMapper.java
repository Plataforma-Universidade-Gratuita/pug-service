 ...
 * User}) does not leak into or depend upon the JPA Persistence model ({@link UserEntity}) or the
...
public final class UserMapper {
   ...
   * Objects (e.g., using {@link Cpf#factory(String)} and {@link AuditInfo}).
   *
  ...
  /**
   * Translates a pure Domain {@link User} aggregate into a newly instantiated JPA {@link
   * UserEntity}.
   *
  ...
  /**
   * Updates an existing, attached JPA {@link UserEntity} with the current state of a Domain {@link
   * User}.
   *

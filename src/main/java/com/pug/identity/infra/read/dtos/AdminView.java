 ...
 * client. It flattens the internal domain relationships by nesting the underlying account details
 * ({@link AccountView}) alongside the specific administrator privileges and operational boundaries.
 *

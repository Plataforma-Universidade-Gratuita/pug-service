 ...
 * operations for retrieving authentication account data directly into lightweight
 * {@link AccountView} projections, bypassing the overhead of instantiating full
...
public interface AccountQueries {
   ...
   * @return an {@link Optional} containing the {@link AccountView} if found, or {@link Optional#empty()} otherwise
   */
   ...
   * <p>
   * This query implicitly joins account data with the underlying user data to filter
   * by the natural key of the individual.
   *
   ...
   * to resolve the individual's name and project the resulting account data.
   *

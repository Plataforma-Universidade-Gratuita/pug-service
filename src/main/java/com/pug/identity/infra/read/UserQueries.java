 ...
 * operations for retrieving user data directly into lightweight {@link UserView}
...
public interface UserQueries {
   ...
   * @return an {@link Optional} containing the {@link UserView} if found, or {@link Optional#empty()} otherwise
   */
   ...
   * @return a sorted {@link List} of {@link UserView} entries matching the search criteria,

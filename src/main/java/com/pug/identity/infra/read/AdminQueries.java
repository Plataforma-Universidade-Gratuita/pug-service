 ...
 * operations for retrieving consolidated administrator profiles directly into lightweight
 * {@link AdminView} projections. These views typically aggregate data across the
 * Admin, Account, and User contexts for optimized API delivery.
 */
public interface AdminQueries {
   ...
   * @return an {@link Optional} containing the {@link AdminView} if found, or {@link Optional#empty()} otherwise
   */
   ...
   * to provide fuzzy matching and predictive autocomplete capabilities based on the admin's name.
   *

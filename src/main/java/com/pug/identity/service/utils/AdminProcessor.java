 ...
 * pure {@link Admin} Domain Aggregates.
 */
public class AdminProcessor {
   ...
   * <p>
   * <b>Note:</b> The caller is responsible for checking {@link Admin#hasFieldErrors()}
   ...
   * @return a fully instantiated {@link Admin} domain aggregate, potentially containing validation errors
   */
   ...
   * @return a new {@link Admin} domain aggregate reflecting the requested updates, potentially containing validation errors
   */

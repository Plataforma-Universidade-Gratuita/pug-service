 ...
 * throughout the identity module.
 */
public final class ExceptionHelper {
     ...
     * that a User with the specified CPF already exists in the system.
     *
     ...
     * that a requested User could not be located.
     *
    ...
    /**
     * Instantiates a standardized {@link ResourceNotFoundException} indicating
     * that a requested Administrator profile could not be located.
     *
     * @return a fully configured {@link ResourceNotFoundException} instance
     */
    ...
    /**
     * Instantiates a standardized {@link DuplicateResourceException} indicating
     * that an Account with the specified email address already exists in the system.
     *
     * @return a fully configured {@link DuplicateResourceException} instance
     */
    ...
    /**
     * Instantiates a standardized {@link ResourceNotFoundException} indicating
     * that a requested authentication Account could not be located.
     *
     * @return a fully configured {@link ResourceNotFoundException} instance
     */

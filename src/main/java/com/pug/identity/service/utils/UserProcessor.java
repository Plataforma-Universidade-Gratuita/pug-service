 ...
 * pure {@link User} Domain Aggregates and Value Objects.
 * <p>
...
public class UserProcessor {
   ...
   * (e.g., {@link Cpf}) before passing them to the entity's factory method.
   * <p>
   * <b>Note:</b> The returned {@link User} object may contain accumulated domain validation
   * failures. The caller is responsible for checking {@link User#hasFieldErrors()} and
   ...
   * @return a fully instantiated {@link User} domain aggregate, potentially containing validation errors
   */
   ...
   * returns a <i>new</i> instance of the {@link User} reflecting the applied changes.
   *
   ...
   * @return a new {@link User} domain aggregate reflecting the requested updates, potentially containing validation errors
   */

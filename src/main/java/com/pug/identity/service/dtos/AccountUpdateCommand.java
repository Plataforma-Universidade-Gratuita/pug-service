 ...
 * <p>
 * This record encapsulates the requested state changes for an account. The fields are typically
 ...
 * @param userCommand  the nested command for updating the associated user, or {@code null} to leave unchanged
 */

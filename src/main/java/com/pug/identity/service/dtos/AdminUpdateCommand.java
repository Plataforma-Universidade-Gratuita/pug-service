 ...
 * <p>
 * This record encapsulates the requested state changes for an admin profile. The fields,
 * including the nested account command, are treated as optional for partial updates.
 *
 * @param accountCommand the nested command containing the data to update the underlying account, or {@code null}

...
/**
 * Data Transfer Object (DTO) acting as an application command to create a new authentication Account.
 * <p>
 * This record encapsulates the raw input data required by the application service to
 * instantiate a new {@link com.pug.identity.domain.Account} aggregate, alongside the
 * nested command needed to provision its underlying {@link com.pug.identity.domain.User}.
 *

...
public interface IAccountReadService {
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no account with the given ID is found
     */
     ...
     * @return the AccountView
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no account with the given email is found
     */

...
import com.pug.identity.service.dtos.UpdateUserCommand;
...
public class UserService {
   ...
   */
  @Transactional
  public User save(CreateNewUserCommand cmd) {
   ...
   */
  @Transactional
  public List<User> saveAll(Iterable<CreateNewUserCommand> cmds) {

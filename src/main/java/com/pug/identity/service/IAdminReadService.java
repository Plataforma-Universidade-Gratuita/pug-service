...
public interface IAdminReadService {
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no admin with the given account ID is found.
     */
     ...
     * @return the AdminView.
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no admin with the given email is found.
     */

...
public interface IUserReadService {
     ...
     * @return the UserView
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no user with the given ID is found
     */
     ...
     * @return the UserView
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no user with the given CPF is found
     */

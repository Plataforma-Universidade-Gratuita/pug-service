...
public interface IUserService {
  ...
  /**
   * Helper method for AccountService to process users in bulk (find or create) and collect
   * validation problems.
   *
   ...
   */
  Map<Cpf, UUID> processUsersForAccounts(
      List<String> rawCpfStrings,
      List<com.pug.shared.exceptions.AppValidationException.Problem> problems);

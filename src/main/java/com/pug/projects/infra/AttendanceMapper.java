 ...
 * <p>
 * This mapper handles the translation of complex Value Objects related to geolocation,
...
public final class AttendanceMapper {
     ...
     * @return a fully constructed Domain {@link Attendance}, or {@code null} if the input entity is null
     */
    ...
    /**
     * Translates a pure Domain {@link Attendance} aggregate into a newly instantiated JPA {@link AttendanceEntity}.
     *
     * @param d the Domain aggregate to convert
     * @return a newly constructed JPA {@link AttendanceEntity}, or {@code null} if the input domain is null
     */
    ...
    /**
     * Updates an existing, attached JPA {@link AttendanceEntity} with the current state of a Domain {@link Attendance}.
     *
    ...
    /**
     * Projects a raw JPA {@link AttendanceEntity} and its pre-resolved nested views into
     * a comprehensive {@link AttendanceView} DTO.
     *

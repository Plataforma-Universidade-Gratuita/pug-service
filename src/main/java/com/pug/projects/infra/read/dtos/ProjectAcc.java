 ...
 * <p>
 * Acts as an intermediate data structure during complex cross-domain queries.
 * By fetching the {@link ProjectEntity} and all its required associations (Partner Entity,
 * City, Creator Account, Creator User) in a single query projection, it prevents N+1

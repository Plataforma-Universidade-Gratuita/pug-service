 ...
 * <p>
 * Fetches the base persistence entities required to build an {@link AttendanceView}
 * in a single query projection, mapping the attendance record to its project, student,
 * and the staff member (validator) who approved it.
 */

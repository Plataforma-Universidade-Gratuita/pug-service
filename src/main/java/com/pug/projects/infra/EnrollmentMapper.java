 ...
 * <p>
 * This mapper acts as an anti-corruption layer, handling the conversion of the composite
...
public final class EnrollmentMapper {
     ...
     * @return a fully constructed Domain {@link Enrollment}, or {@code null} if the input entity is null
     */
    ...
    /**
     * Translates a pure Domain {@link Enrollment} aggregate into a newly instantiated JPA {@link EnrollmentEntity}.
     *
     * @param d the Domain aggregate to convert
     * @return a newly constructed JPA {@link EnrollmentEntity}, or {@code null} if the input domain is null
     */
    ...
    /**
     * Updates an existing, attached JPA {@link EnrollmentEntity} with the current state of a Domain {@link Enrollment}.
     *
    ...
    /**
     * Projects a raw JPA {@link EnrollmentEntity} and its pre-resolved nested views into
     * a comprehensive {@link EnrollmentView} DTO.
     * <p>
     * Since resolving Projects and Students requires deep query joins across multiple modules,

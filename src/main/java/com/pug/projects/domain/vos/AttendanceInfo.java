 ...
 * regarding the timestamp and the identity of the staff member who validated the attendance.
 */
@Getter
@Value
...
public class AttendanceInfo extends DomainError {
   ...
   * <p>
   * Initializes standard audit tracking information and immediately validates the state.
   *
   * @param validatedBy the unique identifier of the validating staff member
   * @param validatedAt the timestamp of validation
   ...
   *       (appends {@link ProjectsFieldErrorCodes#INVALID_ATTENDANCE_STATUS_BLANK} if mismatched).</li>
   *   <li>The validation timestamp cannot chronologically precede the creation timestamp
   *       (appends {@link ProjectsFieldErrorCodes#INVALID_CREATED_AT_FUTURE}).</li>

 ...
 * <p>
 * This class acts as an aggregate containing the unique identifier, the linked enrollment,
 * the geolocation data (QR Validation), and the staff validation metadata. It extends
...
public class Attendance extends DomainError {
   ...
   * <p>
   * Initializes the attendance in a {@code WAITING} state with empty validation info.
   *
   ...
   * <p>
   * This behavior simulates a staff member confirming the student's geographic presence
   * and time spent via a QR code scan.
   *

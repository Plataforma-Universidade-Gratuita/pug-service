 ...
 * <p>
 * This enum implements {@link GenericFieldErrorCodes} to provide a standardized contract
 * for localized error messages mapped to specific domain properties.
...
public enum ProjectsFieldErrorCodes implements GenericFieldErrorCodes {
   ...
   */
  INVALID_ATTENDANCE_DURATION_INVALID("error.domain.projects.attendance.duration.invalid", "duration"),

  /**
   * Indicates that the provided latitude is out of the valid range (-90 to 90).
   */
  INVALID_ATTENDANCE_GEO_INVALID_LAT("error.domain.projects.attendance.geo.invalid.lat", "latitude"),

  /**
   * Indicates that the provided longitude is out of the valid range (-180 to 180).
   */
  INVALID_ATTENDANCE_GEO_INVALID_LONG("error.domain.projects.attendance.geo.invalid.long", "longitude"),

  /**
   * Indicates that geolocation data is partially missing (e.g., has latitude but no longitude).
   */
  INVALID_ATTENDANCE_GEO_INVALID_MISSING("error.domain.projects.attendance.geo.invalid.missing", null),
  ...
  /**
   * Indicates that enrollment timestamps (e.g., acceptedAt) are chronologically invalid relative to creation.
   */
   ...
   */
  INVALID_ENROLLMENT_REQUEST_AT_BLANK("error.domain.projects.enrollment.requestat.blank", "requestAt"),
   ...
   */
  INVALID_MAX_PARTICIPANTS_NEGATIVE("error.domain.projects.maxparticipants.negative", "maxParticipants"),
   ...
   */
  INVALID_PROJECT_STATUS_UPDATE_CANCEL("error.domain.projects.status.update.cancel", "projectStatus"),

  /**
   * Indicates an invalid attempt to update a project's status to COMPLETE.
   */
  INVALID_PROJECT_STATUS_UPDATE_COMPLETE("error.domain.projects.status.update.complete", "projectStatus"),

  /**
   * Indicates an invalid attempt to update a project's status to ON HOLD.
   */
  INVALID_PROJECT_STATUS_UPDATE_PUT_ON_HOLD("error.domain.projects.status.update.put.on.hold", "projectStatus"),

  /**
   * Indicates an invalid attempt to update a project's status to RETAKE.
   */
  INVALID_PROJECT_STATUS_UPDATE_RETAKE("error.domain.projects.status.update.retake", "projectStatus"),
  ...
  /**
   * The property key used to resolve the localized error message in the application's resource bundles.
   */

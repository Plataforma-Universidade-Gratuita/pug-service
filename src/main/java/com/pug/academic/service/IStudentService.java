...
public interface IStudentService {
     ...
     * @throws com.pug.shared.exceptions.DuplicateResourceException if a student with the same academic registration already exists,
     ...
     * @throws com.pug.shared.exceptions.DuplicateResourceException if any student with the same academic registration already exists,
     *                                                              or if there are duplicate registrations or emails in the input commands.
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if any associated course does not exist.
     * @throws com.pug.shared.exceptions.AppValidationException     if input validation fails for any student in the bulk.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if the student with the given account ID does not exist,
     *                                                              or if the new course does not exist.
     * @throws com.pug.shared.exceptions.DuplicateResourceException if a student with the new academic registration already exists,
     ...
     * @throws com.pug.shared.exceptions.ReferencedEntityException if any student is still referenced by other modules (e.g. Enrollments).
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if a student's account is not found during cascata deletion.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no student is found (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if any Student entity found is corrupted in the database.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if the student with the given account ID does not exist (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if the student is found but its data is corrupted in the database.
     */

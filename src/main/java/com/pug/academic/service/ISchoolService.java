...
public interface ISchoolService {
     ...
     * @throws com.pug.shared.exceptions.DuplicateResourceException if a school with the same name already exists.
     ...
     * @throws com.pug.shared.exceptions.DuplicateResourceException if any school with the same name already exists,
     *                                                              or if there are duplicate names in the input commands.
     * @throws com.pug.shared.exceptions.AppValidationException     if input validation fails for any school in the bulk.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if the school with the given ID does not exist.
     * @throws com.pug.shared.exceptions.DuplicateResourceException if a school with the same name already exists.
     * @throws com.pug.shared.exceptions.AppValidationException     if input validation fails.
     */
     ...
     * @throws com.pug.shared.exceptions.ReferencedEntityException if any school is still referenced by other modules.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no school is found (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if any School entity found is corrupted in the database.
     */
    List<School> listAll();
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if the school with the given ID does not exist (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if the school is found but its data is corrupted in the database.
     */
     ...
     * @return the School entity.
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if the school with the given name does not exist (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if the school is found but its data is corrupted in the database.
     */

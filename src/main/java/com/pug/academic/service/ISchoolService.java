...
public interface ISchoolService {
   ...
   *     corrupted in DB).
   * @throws com.pug.shared.exceptions.AppValidationException if any School entity found is
   ...
   * @throws com.pug.shared.exceptions.AppValidationException if the school is found but its data is
   *     corrupted in the database.
   */

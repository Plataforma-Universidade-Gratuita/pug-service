...
public interface CourseService {
   ...
   * @throws com.pug.shared.exceptions.DuplicateResourceException if a course with the exact same
   *     name already exists
   ...
   * @throws com.pug.shared.exceptions.ResourceNotFoundException if the course does not exist, or if
   *     the new school does not exist
   * @throws com.pug.shared.exceptions.DuplicateResourceException if the updated name conflicts with
   *     an existing course

...
public interface IStudentReadService {
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no Student with the given ID is found
     */
     ...
     * @return the StudentView
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no Student with the given academic registration is found
     */

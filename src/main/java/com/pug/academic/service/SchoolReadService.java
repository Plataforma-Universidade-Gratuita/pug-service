 ...
 * domain logic and retrieves lightweight {@link SchoolView} Data Transfer Objects directly from the
 * underlying data store or search indices.
 */
public interface SchoolReadService {
   ...
   * @throws com.pug.shared.exceptions.ResourceNotFoundException if no school matches the provided
   *     ID
   */

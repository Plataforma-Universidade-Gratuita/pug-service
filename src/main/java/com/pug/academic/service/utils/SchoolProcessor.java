 ...
 * pure {@link School} Domain Aggregates.
 */
public class SchoolProcessor {
   ...
   * <p>
   * <b>Note:</b> The caller is responsible for checking {@link School#hasFieldErrors()}
   ...
   * @return a fully instantiated {@link School} domain aggregate, potentially containing validation errors
   */
   ...
   * <p>
   * Applies partial updates, returning a new immutable instance of the aggregate.
   *
   ...
   * @return a new {@link School} domain aggregate reflecting the requested updates, potentially containing validation errors
   */

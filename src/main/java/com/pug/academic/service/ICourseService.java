...
public interface ICourseService {
     ...
     * @throws com.pug.shared.exceptions.DuplicateResourceException if any course with the same name already exists,
     *                                                              or if there are duplicate names in the input commands.
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if any associated school does not exist.
     * @throws com.pug.shared.exceptions.AppValidationException     if input validation fails for any course in the bulk.
     */
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException  if the course with the given ID does not exist,
     *                                                              or if the new school does not exist.
     * @throws com.pug.shared.exceptions.DuplicateResourceException if a course with the new name already exists.
     * @throws com.pug.shared.exceptions.AppValidationException     if input validation fails.
     */
     ...
     * @throws com.pug.shared.exceptions.ReferencedEntityException if any course is still referenced by students.
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if no course is found (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if any Course entity found is corrupted in the database.
     */
    List<Course> listAll();
     ...
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if the course with the given ID does not exist (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if the course is found but its data is corrupted in the database.
     */
     ...
     * @return the Course entity.
     * @throws com.pug.shared.exceptions.ResourceNotFoundException if the course with the given name does not exist (or data is corrupted in DB).
     * @throws com.pug.shared.exceptions.AppValidationException    if the course is found but its data is corrupted in the database.
     */

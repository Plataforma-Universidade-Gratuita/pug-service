...
@ApplicationScoped
public class FieldOfStudyRepository implements PanacheRepositoryBase<FieldOfStudy, UUID> {
  ...
  public List<FieldOfStudy> listAllSorted() {
    return list("order by name asc");
  }

  public List<FieldOfStudy> listByPattern(String q, int limit) {
    String normalized =

 ...
 * operations for retrieving school data directly into lightweight {@link SchoolView}
 * projections, bypassing the overhead of instantiating full JPA entities.
 */
public interface SchoolQueries {
   ...
   * @return an {@link Optional} containing the found {@link SchoolView}, or {@link Optional#empty()} if not found
   */

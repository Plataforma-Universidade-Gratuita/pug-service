 ...
 * to the client. It flattens the internal domain structure and aggregates the associated
 * {@link SchoolView} to provide a lightweight structure optimized for JSON serialization.
 *

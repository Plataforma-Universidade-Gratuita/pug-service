 ...
 * client. It flattens complex domain value objects and nests the underlying authentication identity
 * ({@link AccountView}) alongside academic details ({@link CourseView}) into a comprehensive

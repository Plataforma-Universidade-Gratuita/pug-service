 ...
 * translating complex nested value objects like {@link CounterpartHours} and {@link Period}
 * to and from flat database columns. It also handles the assembly of deeply nested
 * CQRS read views that cross module boundaries (Identity, Academic).
 */
public final class StudentMapper {
  ...
  /**
   * Translates a pure Domain {@link Student} aggregate into a newly instantiated JPA {@link StudentEntity}.
   *
   * @param d the Domain aggregate to convert
   * @return a newly constructed JPA {@link StudentEntity}, or {@code null} if the input domain is null
   */
  ...
  /**
   * Updates an existing, attached JPA {@link StudentEntity} with the current state of a Domain {@link Student}.
   *
   ...
   * that encapsulate the student's profile, credentials, and academic details

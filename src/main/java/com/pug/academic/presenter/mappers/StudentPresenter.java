...
public final class StudentPresenter {
  ...
  public static StudentResponse toResponse(StudentView v, Locale locale, I18n i18n) {
    ...
    long remainingDays = ChronoUnit.DAYS.between(LocalDate.now(), v.dueDate());
    String remainingDaysFormatted = PresenterUtils.formatRemainingDays(v.dueDate(), locale, i18n);

 ...
 * aggregate for managing a student's enrollment status, including their academic registration,
...
public class Student extends DomainError {
   ...
   *
   * <p>Since this entity is immutable, this method returns a new {@code Student} instance with the
   * updated campus and a refreshed {@link AuditInfo} timestamp.
   *
   * @param newCampus the new {@link Campi} to set
   * @return a new, updated, and validated {@link Student} instance, or {@code this} if the campus
   *     is unchanged
   */
   ...
   * @return a new, updated, and validated {@link Student} instance, or {@code this} if the
   ...
   * @return a new, updated, and validated {@link Student} instance, or {@code this} if the course
   *     is unchanged
   */
   ...
   * @return a new, updated, and validated {@link Student} instance, or {@code this} if the hours
   *     are unchanged
   */
   ...
   * @return a new, updated, and validated {@link Student} instance, or {@code this} if the period
   *     is unchanged
   */

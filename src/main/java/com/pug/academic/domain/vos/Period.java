 ...
 *
 * <p>Also contains a method to calculate remaining days until the due date.</p>
 *
...
public record Period(LocalDate startDate, LocalDate dueDate) {
   ...
   * @throws AppValidationException if the dates are null or if the due date is before the start date
   */
  public Period {

 ...
 * <p>
 * Extends {@link DomainError} to encapsulate validations relating to time requirements,
 * ensuring hours are properly quantified and avoiding negative/zero time constraints.
 */
@Getter
@Value
...
public class CounterpartHours extends DomainError {
   ...
   * <p>
   * If the {@code concluded} flag is omitted (null), it defaults to {@code false}.
   * The returned instance is immediately self-validated.
   *
   ...
   * <ul>
   *   <li>The required hours must not be null (appends {@link AcademicFieldErrorCodes#INVALID_HOURS_BLANK})</li>
   *   <li>The required hours cannot be negative (appends {@link AcademicFieldErrorCodes#INVALID_REQUIRED_HOURS_NEGATIVE})</li>
   *   <li>The required hours cannot be exactly zero (appends {@link AcademicFieldErrorCodes#INVALID_REQUIRED_HOURS_ZERO})</li>
   * </ul>
   */

...
public enum AcademicErrorCodes implements GenericCodes {
  ...
  /**
   * Indicates an attempt to create or update an academic course using a name
   * that is already registered in the system.
   */
  COURSE_ALREADY_EXISTS("error.domain.academic.course.already.exists"),

  /**
   * Indicates that a requested academic course could not be located in the underlying
   * data store by its unique identifier or name.
   */
  COURSE_NOT_FOUND("error.domain.academic.course.not.found"),

  /**
   * Indicates an attempt to create or update an academic school using a name
   * that is already registered to another school in the system.
   */
  SCHOOL_ALREADY_EXISTS("error.domain.academic.school.already.exists"),

  /**
   * Indicates that a requested academic school could not be located in the underlying
   * data store by its unique identifier.
   */
  SCHOOL_NOT_FOUND("error.domain.academic.school.not.found"),

  /**
   * Indicates an attempt to enroll a student using an academic registration string
   * that is already assigned to an existing student.
   */
  STUDENT_ALREADY_EXISTS("error.domain.academic.student.already.exists"),

  /**
   * Indicates that a requested student enrollment record could not be located in the

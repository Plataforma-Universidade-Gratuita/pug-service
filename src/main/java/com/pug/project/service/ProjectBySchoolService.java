 ...
 * com.pug.project.domain.Project} and {@link com.pug.academic.domain.School} aggregates via {@link
 * ProjectBySchool}.
 *
...
public interface ProjectBySchoolService {
   ...
   * @throws com.pug.shared.exceptions.AppValidationException if any created association violates

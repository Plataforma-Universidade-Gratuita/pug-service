...
/**
 * Implementation of the {@link EntityQueries} interface using JPA.
 *
...
public class EntityQueriesImpl implements EntityQueries {
   ...
   * {@inheritDoc}
   *
   * <p>To achieve a name-based search against the entity's name, this implementation first resolves
   * the matching entities via the database filter and then projects them directly into flattened

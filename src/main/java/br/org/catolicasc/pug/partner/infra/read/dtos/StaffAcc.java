 ...
 * fetching the {@link StaffEntity} and all its required associations (Account, Entity, City) in a
 * single query projection, it prevents N+1 select performance issues before the data is ultimately
 * mapped into the final, client-facing {@link StaffView}.
 *

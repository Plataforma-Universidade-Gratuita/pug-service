...
public interface StaffQueries {
     ...
     *
     * <p>The search may filter staff by active account status, CPF, email, creation/update date range,
     * username, and linked partner entity identifiers. Results are ordered by the associated user's

 ...
 * and delete partner staff members. Implementations coordinate staff persistence with linked account
 * management, partner entity validation, business-rule enforcement, and audit publication.
 */
public interface StaffService {
     ...
     * business records, such as created projects or validated attendances. When deletion succeeds, the
     * linked account is also removed.
     *

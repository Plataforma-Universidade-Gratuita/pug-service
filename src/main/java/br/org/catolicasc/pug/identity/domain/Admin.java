 ...
 *
 * <p>This class maps administrative privileges and location boundaries directly to an existing
 * {@link Account}. It serves as an aggregate for metadata strictly tied to administration rights.
...
public class Admin extends DomainError {
   ...
   *
   * <p>Automatically stamps the creation operation with the current system time and performs full
   ...
   *
   * <p>Since this entity is immutable, this method returns a new {@code Admin} instance reflecting
   * the new campus. The new instance is fully re-validated.
   *
   * @param newCampus the new {@link Campi} to assign
   * @return a new, updated, and validated {@link Admin} instance, or {@code this} if the campus is
   *     unchanged
   */

 ...
 * areas of expertise. It returns immutable read-model projections and delegates persistence-specific
 * query behavior to the infrastructure layer, keeping query flows separated from command
 * operations.
 */

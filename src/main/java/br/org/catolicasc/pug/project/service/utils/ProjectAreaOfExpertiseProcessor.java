...
/**
 * Stateless utility class responsible for mapping raw command data into pure {@link ProjectAreaOfExpertise}
 * Domain Aggregates.
 *
 * <p>This processor centralizes the orchestration of the {@link ProjectAreaOfExpertise} factory, ensuring
...
public final class ProjectAreaOfExpertiseProcessor {
   ...
   *
   * <p>This method delegates to {@link ProjectAreaOfExpertise#factory(UUID, UUID)}, which immediately
   * self-validates the created aggregate. The caller is responsible for inspecting {@link
   * ProjectAreaOfExpertise#hasFieldErrors()} and handling any collected validation problems (for example, by
   * throwing an {@link AppValidationException}).
   *
   * @param projectId the unique identifier of the project
   * @param areaOfExpertiseId the unique identifier of the areaOfExpertise
   * @return a fully instantiated {@link ProjectAreaOfExpertise} domain aggregate, potentially containing
   *     validation errors
   */

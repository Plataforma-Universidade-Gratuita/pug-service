 ...
 *
 * <p>This record acts as a flexible container capable of holding any structured data (such as a
 * {@link java.util.List} of {@link FieldErrorsResponse}, a specific Map, or a custom POJO). The
 * {@link JsonValue} annotation ensures that Jackson serializes the underlying {@code payload}
